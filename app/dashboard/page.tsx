  ...
  return (
    <ProtectedRoute>
      <div className="flex justify-start gap-6 transition-all  duration-300 ease-in-out">
        <div className={`${sideActive ? 'absolute' : 'relative'}  md:relative bg-[#EBF5FB]   pt-5 h-[90vh]  w-auto z-20`}>
        ...
        <div className={`md:hidden block bg-[#EBF5FB] pt-5 w-[70px] ${sideActive ? '' : 'hidden'}`}></div>
        ...
        <div className="md:w-[200px] hidden lg:block z-0 absolute right-0 h-[80vh]  ">
          <div className="relative">
            <Image src={'/image/dashboard/Star.png'} alt="star" width={100} height={100} className="w-[90px] absolute left-2 top-9" />
