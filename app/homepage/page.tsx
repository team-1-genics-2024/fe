...
const LearningPathSection = () => {
  ...
  return (
    <div>
      <h1 className="font-semibold text-4xl text-gray-800 text-center mb-16 mt-24">Daftar Learning Path Rancangan Experts</h1>
  ...
  const handleSignUp = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        const errorMessage = errorData.errorMessage || 'Please double check your credentials';
      ...
      <div>
        <div className="relative h-screen bg-white flex items-center justify-center text-center overflow-hidden">
          <div className="absolute -right-[20px] top-[3%] hidden lg:block">
            <Image src="/image/homepage/rightstar.png" alt="Left Star" width={120} height={120} />
          </div>

          <div className="absolute left-[-20px] top-[70%] hidden lg:block">
            <Image src="/image/homepage/leftstar.png" alt="Right Star" width={190} height={190} />
          </div>

          <div className="flex flex-col items-center">
            <div className="flex justify-start w-full left-[-10px] top-[5%]">
              <Image src="/image/homepage/upperrightstar.png" alt="Upper Left Star" width={100} height={100} />
            </div>

            <div className="text-center mt-28 w-full h-[40vh] overflow-hidden z-10">
              <h1 className="text-4xl md:text-6xl font-bold mb-6 w-full md:w-[690px]">Ayo raih prestasi gemilang bersama!</h1>
                    ...
                    {isEnrolled && (
                      <>
                        ...
                        <DialogTrigger asChild>
                          <button className="bg-[#3498DB] text-white px-4 py-2 rounded-full w-full mr-2">Gabung sekarang</button>
                        </DialogTrigger>
                        <button onClick={handlePaymentClick} className="border border-[#3498DB] text-[#3498DB] px-4 py-2 rounded-full w-full ml-2">
                          Lihat harga
                        </button>
                      </>
                    )}
                        ...
                        <div className="w-full lg:w-1/2 lg:pl-2">
                          ...
                          <CardContent className="space-y-4">
                            <form onSubmit={handleSignUp} className="space-y-2">
                              ...
                              <SubmitButtonSignUp isSubmitting={isSubmittingSignUp} />
                            </form>
                            ...
                            <div className="space-y-2 sm:bottom-[20%]">
                              ...
                              <p className="text-[#747a7e]  text-center text-[11px] font-medium leading-none tracking-wide">Unlock Your Potential, Shape Your Future – Start Learning Today!</p>
                            </div>
                          </CardContent>
                        </div>
                      </div>
            ...
            <div className="flex justify-end mb-28 w-full px-8">
              <Image src="/image/homepage/lowerrightstar.png" alt="Upper Right Star" width={100} height={100} />
            </div>
          </div>
        </div>
