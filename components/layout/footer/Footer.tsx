...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-[#16405C] text-white mt-20">
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-4 gap-8  mt-8">
          ...
          <div>
            <h3 className="font-normal mb-4">Course</h3>
            <ul className="space-y-2">
          ...
          <div>
            <div className="mb-6">
              <h3 className="font-normal mb-2">Contact Us</h3>
            ...
            <div>
              ...
              <div className="flex space-x-4">
                ...
                <Link
                  href="https://id.wikipedia.org/wiki/Log_masuk"
                  className="text-white hover:text-gray-300"
                  target="blank"
                >
                  <svg
