        ...
        <div className="w-full lg:w-1/2">
          ...
          <CardContent className="space-y-2 lg:mt-14">
            <form action="" id="contact_form" onSubmit={onSubmitForm}>
              ...
              <Button className="w-full bg-blue-500 hover:bg-blue-600 text-white py-2 rounded-lg transition-colors" disabled={pending} type="submit">
              ...
              <Button variant="outline" className="w-full border text-blue-500 border-gray-400 dark:border-gray-700 rounded-lg p-2 flex items-center justify-center space-x-2 hover:bg-gray-50 dark:hover:bg-gray-700 hover:text-blue-600">
