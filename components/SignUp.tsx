      ...
      <div className="w-full max-w-md lg:max-w-4xl lg:flex lg:items-center lg:justify-between p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg relative">
        ...
        <div className="w-full lg:w-1/2">
          ...
          <CardContent className="space-y-2 lg:mt-14">
            ...
            <Button
              variant="outline"
              className="w-full border text-blue-500 border-gray-400 dark:border-gray-700 rounded-lg p-2 flex items-center justify-center space-x-2 hover:bg-gray-50 dark:hover:bg-gray-700 hover:text-blue-600"
            >
            ...
            <p className="text-sm text-center text-gray-500 dark:text-gray-400">
              ...
              <Link href="/login" target='_blank' className="text-blue-400 underline font-bold">
                Log in
              </Link>
